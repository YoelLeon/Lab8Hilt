...
import com.lab8.hiltapp.data.ProductRepositoryImpl;
import com.lab8.hiltapp.domain.GetProductsUseCase;
import com.lab8.hiltapp.ui.ProductViewModel;
import com.lab8.hiltapp.ui.ProductViewModel_HiltModules;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_lab8_hiltapp_ui_ProductViewModel, ProductViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_lab8_hiltapp_ui_ProductViewModel = "com.lab8.hiltapp.ui.ProductViewModel";

      @KeepFieldType
      ProductViewModel com_lab8_hiltapp_ui_ProductViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    private GetProductsUseCase getProductsUseCase() {
      return new GetProductsUseCase(singletonCImpl.bindProductRepositoryProvider.get());
    }
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_lab8_hiltapp_ui_ProductViewModel, ((Provider) productViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.lab8.hiltapp.ui.ProductViewModel 
          return (T) new ProductViewModel(viewModelCImpl.getProductsUseCase());
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.lab8.hiltapp.data.ProductRepositoryImpl 
